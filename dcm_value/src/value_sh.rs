...
crate::to_dicom_object_for_string!(SH, SH);
crate::to_dicom_object_for_strings!(SHs, SH);

impl<const G: u16, const E: u16> DicomValue<InMemDicomObject> for SH<G, E> {}
impl<const G: u16, const E: u16> DicomValue<InMemDicomObject> for SHs<G, E> {}
